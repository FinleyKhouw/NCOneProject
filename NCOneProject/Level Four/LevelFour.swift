...
class LevelFour: SKScene, SKPhysicsContactDelegate {
    ...
    var bluePad7 = SKSpriteNode()
    var bluePad8 = SKSpriteNode()
    var bluePad9 = SKSpriteNode()
    var bluePad10 = SKSpriteNode()
    ...
    override func didMove(to view: SKView) {
        ...
        bluePad7 = childNode(withName: "BluePad7") as! SKSpriteNode
        bluePad8 = childNode(withName: "BluePad8") as! SKSpriteNode
        bluePad9 = childNode(withName: "BluePad9") as! SKSpriteNode
        bluePad10 = childNode(withName: "BluePad10") as! SKSpriteNode
        ...
        bluePad7.name = "BluePad7"
        bluePad8.name = "BluePad8"
        bluePad9.name = "BluePad9"
        bluePad10.name = "BluePad10"
        ...
        bluePadSetting(pad: bluePad7, nodeName: "BluePad7")
        bluePadSetting(pad: bluePad8, nodeName: "BluePad8")
        bluePadSetting(pad: bluePad9, nodeName: "BluePad9")
        bluePadSetting(pad: bluePad10, nodeName: "BluePad10")
        yellowFinishSetting()
    }
    ...
    override func touchesEnded(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        for touch in touches {
            ...
            } else if (touchedNode.name == "BluePad7") {
                let padClicked = SKAction.run {
                    self.bluePad7.zRotation += CGFloat(Double.pi / 2)
                }
                bluePad7.run(padClicked)
            } else if (touchedNode.name == "BluePad8") {
                let padClicked = SKAction.run {
                    self.bluePad8.zRotation += CGFloat(Double.pi / 2)
                }
                bluePad8.run(padClicked)
            } else if (touchedNode.name == "BluePad8") {
                let padClicked = SKAction.run {
                    self.bluePad6.zRotation += CGFloat(Double.pi / 2)
                }
                bluePad8.run(padClicked)
            } else if (touchedNode.name == "BluePad9") {
                let padClicked = SKAction.run {
                    self.bluePad9.zRotation += CGFloat(Double.pi / 2)
                }
                bluePad9.run(padClicked)
            } else if (touchedNode.name == "BluePad10") {
                let padClicked = SKAction.run {
                    self.bluePad10.zRotation += CGFloat(Double.pi / 2)
                }
                bluePad10.run(padClicked)
